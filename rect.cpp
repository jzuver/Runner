...
bool Rect::isOverlapping(const Rect &r) const {
    ...
    // Note: I know this is different than how the comments specified to implement this method
    // but this is the only way I was able to get it to work
    if(r.getLeftX() > this->getLeftX() && r.getLeftX() < this->getRightX() && r.getTopY() > this->getTopY() && r.getTopY() < this->getBottomY() ){
       return true;
    }
